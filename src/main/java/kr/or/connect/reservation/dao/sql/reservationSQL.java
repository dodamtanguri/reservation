...
public class reservationSQL {
    ...
    public static final String SELECT_RESERVATION_INFOS= "SELECT ri.id, ri.product_id, ri.cancel_flag, ri.display_info_id, ri.user_id, ri.reservation_date, ri.create_date, ri.modify_date from reservation_info ri where ri.user_id = :userID order by create_date DESC LIMIT 1";

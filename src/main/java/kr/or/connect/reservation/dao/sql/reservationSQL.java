...
public class reservationSQL {
    ...
    public static final String SELECT_RESERVATION_INFOS= "SELECT * from reservation_info ri where ri.id = :reservationInfoId";
    public static final String SELECT_RESERVATION_PRICES= "SELECT * from reservation_info_price rip where rip.reservation_info_id = :reservationInfoId";

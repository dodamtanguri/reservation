...
public class DisplayInfosDAO {
    ...
    public List<DisplayInfosDTO> getProduct(Integer displayInfoId) {
        ...
        return jdbc.query(SELECT_DISPLAYINFO_BY_PRODUCT, params, new RowMapper<DisplayInfosDTO>() {
            @Override
    ...
    public List<ProductImagesDTO> getProductImage (Integer displayInfoId) {
        Map<String,Integer> params = new HashMap<>();
        params.put("displayInfoId", displayInfoId);
        return jdbc.query(SELECT_DISPLAYINFO_BY_PRODUCT_IMAGE, params, new RowMapper<ProductImagesDTO>() {
            @Override
            public ProductImagesDTO mapRow(ResultSet resultSet, int i) throws SQLException {
    ...
    public List<DisplayInfosImageDTO> getDisplayinfoImage (Integer displayInfoId) {
        Map<String, Integer> params =new HashMap<>();
        params.put("displayInfoId", displayInfoId);
        return jdbc.query(SELECT_DISPLAYINFO_IMAGE, params, new RowMapper<DisplayInfosImageDTO>() {
            @Override
            public DisplayInfosImageDTO mapRow(ResultSet resultSet, int i) throws SQLException {
    ...
    public List<ProductPricesDTO> getProductPrices(Integer displayInfoId) {
        Map<String, Integer> params =new HashMap<>();
        params.put("displayInfoId", displayInfoId);
        return jdbc.query(SELECT_PRODUCT_PRICES, params, new RowMapper<ProductPricesDTO>() {
            @Override
            public ProductPricesDTO mapRow(ResultSet resultSet, int i) throws SQLException {
